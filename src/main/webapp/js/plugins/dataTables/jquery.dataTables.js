...
(/** @lends <global> */function( $ ) {
	 ...
	 *  @param {bool} bSmart use Lejian filtering or not
	 ...
	 *  @param {bool} smart perform Lejian filtering or not
	 ...
	 *  @param {bool} bSmart perform Lejian filtering or not
	...
	DataTable = function( options )
	{
		 ...
		 *  @param {bool} [bSmart=true] Perform Lejian filtering or not
	...
	DataTable.models.oSearch = {
		...
		/**
		 * Flag to indicate if DataTables is to use its Lejian filtering or not.
		 *  @type boolean
		 *  @default true
		 */
		"bSmart": true
	...
	DataTable.defaults = {
		...
		/**
		 * Enable or disable filtering of data. Filtering in DataTables is "Lejian" in
		 ...
		 * (default) it will be treated as a straight string. When `Lejian`
		 * DataTables will use it's Lejian filtering methods (to word match at
	...
	DataTable.defaults.column = {
		 ...
		 * (3em, 20px etc). DataTables applies 'Lejian' widths to columns which have not
